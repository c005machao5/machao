...
#include "../../client/scrolltext/scrolltext.h"
...
QT_MOC_LITERAL(1, 11, 10), // "outOfRange"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9) // "onTimeout"

    },
    "ScrollText\0outOfRange\0\0onTimeout"
};
...
void ScrollText::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ScrollText::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScrollText::outOfRange)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ScrollText::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ScrollText.data,
