...
#include "../../client/video/videosurface.h"
...
QT_MOC_LITERAL(3, 27, 11) // "QVideoFrame"
    ...
    "VideoSurface\0frameChanged\0\0QVideoFrame"
};
...
void VideoSurface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameChanged((*reinterpret_cast< const QVideoFrame(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (VideoSurface::*_t)(const QVideoFrame & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSurface::frameChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoSurface::frameChanged(const QVideoFrame & _t1)
{
